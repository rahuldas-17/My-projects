...
def binarytreesearch(searchitem):
    global data, left, right, root
    global current
    ...
    if roots==-1:
        ...
        if found==True:
            print (f"{searchitem} found in binary tree!")
        else:
            print (f"Sorry, {searchitem} not found in binary tree!")

binarytreesearch ("Alok")




